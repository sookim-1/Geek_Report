...
final class SearchViewController: BaseUIViewController {
    ...
    typealias DataSource = UICollectionViewDiffableDataSource<Section, AnimeData>
    typealias DataSnapShot = NSDiffableDataSourceSnapshot<Section, AnimeData>
    private var dataSource: DataSource!
    private var searchList: [AnimeData] = []
    ...
    private func configureDataSource() {
        let cellRegistration = UICollectionView.CellRegistration<SearchListCell, AnimeData> { (cell, indexPath, item) in
