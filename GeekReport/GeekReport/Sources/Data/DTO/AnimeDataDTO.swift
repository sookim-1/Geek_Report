...
struct AnimeDetailData: Codable {
    ...
    func toModel() -> DomainAnimeDetailDataModel {
        return DomainAnimeDetailDataModel(animeID: animeID,
                                          title: title,
                                          episodes: episodes,
                                          imageURLString: imageURLs.jpgURLs.largeImageURL,
                                          score: score,
                                          rank: rank,
                                          favorites: favorites,
                                          synopsis: synopsis,
...
struct AnimeData: Codable {
    ...
    func toModel() -> DomainAnimeDataModel {
        return DomainAnimeDataModel(animeID: animeID,
                                    title: title,
                                    episodes: episodes,
                                    imageURLString: imageURLs.jpgURLs.largeImageURL)
    }
